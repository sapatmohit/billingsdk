...
description: The Billing Settings 2 component provides a user-friendly interface for managing billing preferences, payment methods, invoices, and usage limits. This component features a tabbed navigation system, form controls, and an interactive payment card management section.
---

import BillingSetting2Demo from '@/components/billingsdk/billing-settings-2-demo';
...
<Tabs items={['Preview', 'Code']} className="bg-transparent border-none">
  ...
  <Tab value="Code" className="mt-3">
    <include cwd lang="tsx" meta='title="src/components/billingsdk/billing-settings-2-demo.tsx"'>
      src/components/billingsdk/billing-settings-2-demo.tsx
    </include>
  </Tab>
</Tabs>
...
```tsx
import { BillingSetting2 } from '@/components/billingsdk/billing-settings-2';
```
...
<include
	cwd
	lang="tsx"
	meta='title="src/components/billingsdk/billing-settings-2-demo.tsx"'
>
	src/components/billingsdk/billing-settings-2-demo.tsx
</include>

...
| **[Payment Method Manager 2](/docs/components/payment-method-manager-2)** | Secure payment method management with add, remove, and default selection |
...
| **[Billing Settings](/docs/components/billing-settings)**                 | Billing settings component with tabbed navigation for billing preferences, payment methods, invoices, and usage limits |

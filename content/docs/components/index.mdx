...
| **[Payment Method Card](/docs/components/payment-method-card)** | Secure payment method management with add, remove, and default selection |
...
| **[Invoice History Table](/docs/components/invoice-history-table)** | Detailed table view of past invoices with status, amounts, and download options    |
